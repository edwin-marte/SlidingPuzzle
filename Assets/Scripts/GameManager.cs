...
public class GameManager : MonoBehaviour
{
    ...
    private void CreateGamePieces(float gapThickness)
    {
        ...
        for (int row = 0; row < size; row++)
        {
            for (int col = 0; col < size; col++)
            {
                ...
                {
                    // Mapping the UV coordinates appropriately, they are 0->1.
    ...
    void Update()
    {
        ...
        // On click send out ray to see if a piece was clicked.
    ...
    // Namimg the pieces in order so we can use this to check completion.
